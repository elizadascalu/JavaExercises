...
public class City {
    public static void main(String[] args) {
        ...
        Hotel v1 = new Hotel("Continental");
        Museum v2 = new Museum("Museum of Art");
        Church v3 = new Church("St. Joseph");
        Restaurant v4 = new Restaurant("Fenice");
        Restaurant v5 = new Restaurant("Veranda");
        Church v6 = new Church("St. Andrew");
        Church v7 = new Church("St. Mary");
        ...
        LocalTime opening = LocalTime.of(13, 0, 0);
