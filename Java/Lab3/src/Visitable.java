...
public interface Visitable{
    ...
    static Duration getVisitingDuration(LocalTime opening, LocalTime ending){
        LocalDateTime t1=LocalDateTime.of(2021, Month.MARCH,1,opening.getHour(),opening.getMinute(),opening.getSecond());
        LocalDateTime t2=LocalDateTime.of(2021, Month.MARCH,1,ending.getHour(),ending.getMinute(),ending.getSecond());
